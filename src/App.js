...
function App() {
  ...
  return (
    <div className="App">
      <div className="title"> <span className="titleVector1"></span> <span className="titleVector2"></span></div>
      <div className="leftPage">
        <Tiles setModalVisible={setModalVisible} />
        {modalVisible !== false && <Modal modalVisible={modalVisible} setModalVisible={setModalVisible}/>}      
      </div>
